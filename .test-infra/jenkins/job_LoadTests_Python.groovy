...
CronJobBuilder.cronJob('beam_LoadTests_Python_GBK_Dataflow_With_Reiteration_Batch', 'H 12 * * *', this) {
        loadTestsBuilder.loadTests(delegate, CommonTestProperties.SDK.PYTHON, loadTestWithReiterateConfigurations, CommonTestProperties.TriggeringContext.POST_COMMIT, "GBK", "batch")
}